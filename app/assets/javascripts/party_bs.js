(function($){
  ...
  function init_table(data){
    $("#tTrolleys").dataTable({
      ...
      data:data,
      columns:[
        {data:'id',"sWidth":"20px",render:function(data,type,full){
          return "<p style='text-align:left'>"+data+"</p>"
        }},
        {data:'name',"sWidth":"20px",render:function(data,type,full){
          return "<p style='text-align:left'>"+data+"</p>"
        }},
        {data:'uuid',"sWidth":"50px",render:function(data,type,full){
          return "<p style='text-align:left'>"+data+"</p>"
        }},
        {data:'phone',"sWidth":"30px",render:function(data,type,full){
          return "<p style='text-align:left'>"+data+"</p>"
        }},
        {data:'card_number',"sWidth":"20px",render:function(data,type,full){
          return "<p style='text-align:left'>"+data+"</p>"
        }},
        {data:'address',"sWidth":"30px",render:function(data,type,full){
          return "<p style='text-align:left'>"+data+"</p>"
        }},
        {data:'bank',"sWidth":"50px",render:function(data,type,full){
          return "<p style='text-align:left'>"+data+"</p>"
        }}
      ]
    })
