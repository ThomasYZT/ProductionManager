(function($){
  var f_contracts_app = angular.module("f_contracts_app",["f_contracts_services","f_contracts_directives"])
    .controller("indexCtrl",["$scope","getfData",function($scope,getfData){
      $scope.fData = getfData.fData;
      $scope.contracts = $scope.fData.contracts;
      $scope.party_as = $scope.fData.party_as;
      $scope.party_bs = $scope.fData.party_bs;
    ...
    .filter('datefilter', function(){
      return function(input){
        var o = input.slice(0,10).split("-");
        o = o[0]+"年"+o[1]+"月"+o[2]+"日";
        return o;
      }
    });

  var f_contracts_services = angular.module("f_contracts_services",[])
    .factory("getfData",function(){
      var fData;
      $.ajax({
        type:"get",
        url:"/f_contracts",
  ...
  var f_contracts_directives = angular.module("f_contracts_directives",[]);    
