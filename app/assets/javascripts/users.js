    ...
    $("#tTrolleys").DataTable({
      ...
      columns:[
        ...
        {data:'description',"sWidth":"100px",render:function(data,type,full){
          return  "<p style='line-height:80px;text-align:left'><a class='btn btn-default btn-xs' onClick='show(this)'>简介详情</a><p class='description' style='display:none;'>"+data+"</p></p>"
        }},
        {data:'barcode',"sWidth":"100px",render:function(data,type,full){
          return "<p style='line-height:80px;text-align:left'>"+data+"</p>"
        }},
